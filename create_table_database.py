...
for sector in sectors:
    cursor.execute("CREATE TABLE IF NOT EXISTS "+database_name+"."+sector+" (`Scrip` VARCHAR(10),`Time` DOUBLE, `Close` VARCHAR(20), `Open` VARCHAR(20), `High` VARCHAR(20), `Low` VARCHAR(20), `Volume` VARCHAR(20))")
db.commit()
cursor.close()
db.close()
